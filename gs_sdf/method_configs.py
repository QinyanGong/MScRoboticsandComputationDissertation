...
from nerfstudio.engine.ddim_splat_trainer import DDIMSplat_TrainerConfig
...
from nerfstudio.models.ddim_splatfacto import DDIMSplatfactoModelConfig
from nerfstudio.models.tensorf import TensoRFModelConfig
from nerfstudio.models.vanilla_nerf import NeRFModel, VanillaModelConfig
from nerfstudio.pipelines.base_pipeline import VanillaPipelineConfig
from nerfstudio.pipelines.dynamic_batch import DynamicBatchPipelineConfig
from nerfstudio.pipelines.ddim_splat_pipeline import DDIMSplatPipelineConfig
...
descriptions = {
    ...
    "ddim_splatfacto":"Gaussian Splatting model for the combination with DDIM",
...
method_configs["ddim_splatfacto"] = DDIMSplat_TrainerConfig(
    method_name="ddim_splatfacto",
    steps_per_eval_image=100,
    steps_per_eval_batch=0,
    steps_per_save=2000,
    steps_per_eval_all_images=1000,
    max_num_iterations=30000,
    mixed_precision=False,
    pipeline=DDIMSplatPipelineConfig(
        datamanager=FullImageDatamanagerConfig(
            dataparser=NerfstudioDataParserConfig(load_3D_points=True),
            cache_images_type="uint8",
        ),
        model=DDIMSplatfactoModelConfig(),
    ),
    optimizers={
        "means": {
            "optimizer": AdamOptimizerConfig(lr=1.6e-4, eps=1e-15),
